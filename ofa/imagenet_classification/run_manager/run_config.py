...
from ofa.imagenet_classification.data_providers import ImagenetDataProvider, CifarDataProvider

__all__ = ['RunConfig', 'ImagenetRunConfig', 'DistributedImageNetRunConfig','DistributedCifarRunConfig', 'CifarRunConfig']
...
class CifarRunConfig(RunConfig):
    ...
    def __init__(self, n_epochs=150, init_lr=0.05, lr_schedule_type='cosine', lr_schedule_param=None,
                 dataset='cifar10', train_batch_size=64, test_batch_size=128, valid_size=None,
                 opt_type='sgd', opt_param=None, weight_decay=4e-5, label_smoothing=0.1, no_decay_keys=None,
                 mixup_alpha=None, model_init='he_fout', validation_frequency=1, print_frequency=10,
                 n_worker=32, resize_scale=0.08, distort_color='tf', image_size=32, **kwargs):
    ...
    def data_provider(self):
        if self.__dict__.get('_data_provider', None) is None:
            if self.dataset == CifarDataProvider.name():
...
class DistributedCifarRunConfig(CifarRunConfig):
    def __init__(self, n_epochs=150, init_lr=0.05, lr_schedule_type='cosine', lr_schedule_param=None,
                 dataset='cifar10', train_batch_size=64, test_batch_size=128, valid_size=None,
                 opt_type='sgd', opt_param=None, weight_decay=4e-5, label_smoothing=0.1, no_decay_keys=None,
                 mixup_alpha=None, model_init='he_fout', validation_frequency=1, print_frequency=10,
                 ...
                 **kwargs):
        super(DistributedCifarRunConfig, self).__init__(
            n_epochs, init_lr, lr_schedule_type, lr_schedule_param,
            dataset, train_batch_size, test_batch_size, valid_size,
            opt_type, opt_param, weight_decay, label_smoothing, no_decay_keys,
            mixup_alpha, model_init, validation_frequency, print_frequency,
        ...
        # Expect these to be passed as keyword arguments
