...
class CifarDataProvider(DataProvider):
	DEFAULT_PATH = '/lustre/hpe/ws12/ws12.a/ws/xmuyzsun-WK0/ofa-cifar/datasets/'
	...
	def save_path(self):
		if self._save_path is None:
			...
			if not os.path.exists(self._save_path):
				self._save_path = os.path.expanduser('/lustre/hpe/ws12/ws12.a/ws/xmuyzsun-WK0/ofa-cifar/datasets/')
